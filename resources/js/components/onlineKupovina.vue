        ...
        <form>
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="imeNosioca"
                    ...
                    <input type="text" class="form-control" id="brojDana" name="brojDana" :value="brojDana"
                        disabled><br><br>
                    <hr>
                    ...
                    <div v-if="vrstaOsiguranja === 'grupno'">
                        ...
                        <label for="imeOsiguranika" class="form-label">Ime Osiguranika:</label>
                        <input type="text" class="form-control" id="imeOsiguranika" placeholder="Unesite ime osiguranika">


                        <label for="prezimeOsiguranika" class="form-label">Prezime Osiguranika: </label>
                        <input type="text" class="form-control" id="prezimeOsiguranika"
                            placeholder="Unesite prezime osiguranika">

                        <label for="datumRodjenja" class="form-label">Datum rodjenja: </label><br>
                        <date-picker v-model="datumRodjenja" format="'DD. MM. YYYY.'"></date-picker><br>

                        <input type="submit" class="btn btn-outline-primary" name="btnDodajOsiguranika"
                            id="btnDodajOsiguranika"><br><br>
                        <hr>
                    </div>
